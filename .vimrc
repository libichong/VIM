...
" }
" C:\Vim\vim74>vim -u "../.vimrc.bundles" +BundleInstall! +BundleClean +qall
" C:\Users\bichongl>git clone https://github.com/gmarik/vundle.git C:/Vim/.vim/bundle/vundle
" C:\Vim\.vim\bundle>git clone git://github.com/altercation/vim-colors-solarized.git
" C:\Vim\.vim\bundle>git clone https://github.com/tpope/vim-fugitive.git
" :BundleInstall
let $HOME=$VIMHOME
" Environment {
...
" GUI Settings {
    ...
    if has('gui_running')
        ...
        set encoding=utf-8
        set termencoding=utf-8,zh_CN.UTF-8
        ...
        endtry
        set gfn=Fixedsys:h11 gfw=SimHei:h11
